...
/// Belvedere doesn't ship a classical AppDelegate (SwiftUI @main drives the
...
/// compiles. Belvedere never sets this as the actual app delegate, so every
...
class AppDelegate: NSObject, NSApplicationDelegate {
    static let logger = Logger(subsystem: "dev.hamulia.Belvedere", category: "ghostty")

    var undoManager: UndoManager? { nil }
    var ghostty: Ghostty.App { fatalError("Belvedere stub: ghostty accessed on AppDelegate") }
