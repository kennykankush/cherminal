...
/// Stub types lifted from Ghostty.app's controller architecture. Belvedere
...
/// us the correct no-op behavior for features Belvedere doesn't support.

/// Ghostty.app's base window controller. Belvedere uses SwiftUI windows
...
/// Stub for Ghostty.app's restore-from-session error type. Belvedere doesn't
...
/// Stand-in for Ghostty.app's SplitTree. Belvedere has no splits, so the
...
/// Ghostty.app's window subclass. Belvedere uses default NSWindow; this
