...
extension NSWindow {
    ...
    func addTabbedWindowSafely(
        ...
        // Belvedere: ObjC exception-catching wrapper was stripped along with
        // ObjCExceptionCatcher.m. Belvedere has no tab UX, so the dead path
        // here is a direct Cocoa call.
        addTabbedWindow(child, ordered: ordered)
        return true
    }
}
