...
///
/// Stored at `~/Library/Application Support/dev.hamulia.Belvedere/registry.sqlite`.
...
final class SessionCache: @unchecked Sendable {
    private static let logger = Logger(subsystem: "dev.hamulia.Belvedere", category: "cache")
    ...
    private static func databaseURL() throws -> URL {
        ...
        return support
            .appendingPathComponent("dev.hamulia.Belvedere", isDirectory: true)
