...
final class FilesystemWatcher {
    private static let logger = Logger(subsystem: "dev.hamulia.Belvedere", category: "watcher")
    ...
    init(
        ...
        self.queue = DispatchQueue(label: "dev.hamulia.Belvedere.fswatcher", qos: .utility)
    }
