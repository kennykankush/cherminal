...
/// Central design tokens for Belvedere. Every spacing, type ramp, and
...
enum BLV {
    ...
    /// Use `BLV.Font.*` instead of raw `.system(...)` everywhere. The size
    ...
    /// Belvedere's accent — warm clay-orange. Pulled from the Claude
